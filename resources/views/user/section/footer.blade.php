					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								{{-- @foreach($category_item->images as $category_image) --}}
								{{-- <div class="item-slick3" data-thumb="{{ asset('images/product_images/icons/'.$category_image->images) }}"> --}}
