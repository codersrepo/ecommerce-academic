					...
					<div class="p-l-25 p-r-30 p-lr-0-lg">
						<div class="wrap-slick3 flex-sb flex-w">
							...
							<div class="slick3 gallery-lb">
								<div class="item-slick3" data-thumb="{{ asset('images/product_images/icons/'.$product_data->image_icon) }}">
                ...
                @endif
                        ...
                        <div class="p-t-33">
                            ...
                            <div class="flex-w flex-r-m p-b-10">
                                ...
                                @endif
                                <input type="hidden" name="user_id" value="{{ $product_data['id'] }}" required>
							...
							<div class="flex-w flex-r-m p-b-10">
								...
								<div class="size-204 respon6-next">
									<div class="rs1-select2 bor8 bg0">
										<select name="colour" class="js-select2" name="time" required>
											<option value="">Choose an option</option>
					...
					<div class="item-slick2 p-l-15 p-r-15 p-t-15 p-b-15">
						...
						<div class="block2">
							<div class="block2-pic hov-img0">
								<img src="{{ asset('images/product_images/icons/'.$related_products->image_icon) }}" alt="IMG-PRODUCT">
							...
							<div class="block2-txt flex-w flex-t p-t-14">
								<div class="block2-txt-child1 flex-col-l ">
									<a href="{{ route('front.shop.show',$related_products->slug) }}" class="stext-104 cl4 hov-cl1 trans-04 js-name-b2 p-b-6">
                                       {{ $related_products->firstTranslation()->title}}
